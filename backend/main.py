...
from .routers import cards, transactions, dashboard, export, category_budgets, reward_rules, rule_import
...
async def add_security_headers(request, call_next):
    ...
    response.headers["Content-Security-Policy"] = (
        DOCS_CSP if path in {"/docs", "/redoc"} else STRICT_CSP
    )
...
app.include_router(rule_import.router, prefix="/api/rule-import", tags=["rule-import"])
